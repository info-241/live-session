...
##       id         y0        y1
##    <int>      <num>     <num>
## 1:     1 0.06093625 0.3109363
## 2:     2 0.56917951 0.8191795
## 3:     3 0.04419090 0.2941909
## 4:     4 0.28185948 0.5318595
## 5:     5 0.10674195 0.3567419
\end{verbatim}
...
##    <int>      <num>     <num>                   <int>
## 1:     1 0.06093625 0.3109363                       1
## 2:     2 0.56917951 0.8191795                       1
## 3:     3 0.04419090 0.2941909                       1
## 4:     4 0.28185948 0.5318595                       1
## 5:     5 0.10674195 0.3567419                       1
\end{verbatim}
...
##    <int>      <num>     <num>                   <int>                   <num>
## 1:     1 0.06093625 0.3109363                       1                       1
## 2:     2 0.56917951 0.8191795                       1                       0
## 3:     3 0.04419090 0.2941909                       1                       1
## 4:     4 0.28185948 0.5318595                       1                       1
## 5:     5 0.10674195 0.3567419                       1                       1
\end{verbatim}
...
\NormalTok{  d[, bad\_control }\SpecialCharTok{:=}\NormalTok{ .}\DecValTok{5}\SpecialCharTok{*}\NormalTok{tau}\SpecialCharTok{*}\NormalTok{D }\SpecialCharTok{+}\NormalTok{ epsilon]}
\NormalTok{  d[, Y }\SpecialCharTok{:=}\NormalTok{ y0 }\SpecialCharTok{+}\NormalTok{ bad\_control }\SpecialCharTok{+}\NormalTok{ .}\DecValTok{5}\SpecialCharTok{*}\NormalTok{tau}\SpecialCharTok{*}\NormalTok{D }\SpecialCharTok{+}\NormalTok{ epsilon]}
...
##               (0.141)             (0.129) 
##                                           
## bad_control            1.974***  1.970*** 
##                         (0.026)   (0.029) 
##                                           
## Constant       0.050     0.015    -0.005  
##               (0.097)   (0.064)   (0.081) 
##                                           
## ------------------------------------------
## Observations  10,000    10,000    10,000  
## R2             0.072     0.371     0.371  
## Adjusted R2    0.072     0.371     0.371  
## ==========================================
