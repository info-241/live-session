...
\hypersetup{
  ...
  pdfauthor={The 241 Instructional Team\^{}{[}David Reiley, D. Alex Hughes, David Broockman, Micah Gell-Redman, Scott Guenther, David Wheeler, Josue Martinez, Maya Duru},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Experiments and Causality}
\author{The 241 Instructional Team\^{}{[}David Reiley, D. Alex Hughes, David Broockman, Micah Gell-Redman, Scott Guenther, David Wheeler, Josue Martinez, Maya Duru}
\date{2024-08-19}
...
##       id        y0        y1
##    <int>     <num>     <num>
## 1:     1 0.3429360 0.5929360
## 2:     2 0.4033632 0.6533632
## 3:     3 0.9005136 1.1505136
## 4:     4 0.9450945 1.1950945
## 5:     5 0.3530713 0.6030713
\end{verbatim}
...
##    <int>     <num>     <num>                   <int>
## 1:     1 0.3429360 0.5929360                       1
## 2:     2 0.4033632 0.6533632                       0
## 3:     3 0.9005136 1.1505136                       0
## 4:     4 0.9450945 1.1950945                       0
## 5:     5 0.3530713 0.6030713                       0
\end{verbatim}
...
##    <int>     <num>     <num>                   <int>                   <num>
## 1:     1 0.3429360 0.5929360                       1                       0
## 2:     2 0.4033632 0.6533632                       0                       0
## 3:     3 0.9005136 1.1505136                       0                       0
## 4:     4 0.9450945 1.1950945                       0                       0
## 5:     5 0.3530713 0.6030713                       0                       0
\end{verbatim}
...
\NormalTok{  )]}
  ...
  \DocumentationTok{\#\# the bad control is *very* related to treatment}
\NormalTok{  d[, bad\_control }\SpecialCharTok{:=}\NormalTok{ tau}\SpecialCharTok{*}\NormalTok{D }\SpecialCharTok{+}\NormalTok{ epsilon]}
  
  \CommentTok{\# d[, y0 := runif(min={-}10, max=10, n=.N) + bad\_control ]}
  
\NormalTok{  d[, Y }\SpecialCharTok{:=}\NormalTok{ y0 }\SpecialCharTok{+}\NormalTok{ bad\_control }\SpecialCharTok{+}\NormalTok{ epsilon]}
...
\NormalTok{model\_2 }\OtherTok{\textless{}{-}}\NormalTok{ d[ , }\FunctionTok{lm}\NormalTok{(bad\_control }\SpecialCharTok{\textasciitilde{}}\NormalTok{ D)]}
...
##                                    (0.027) 
##                                            
## Constant      0.050      0.028     -0.002  
##              (0.097)    (0.028)    (0.081) 
##                                            
## -------------------------------------------
## Observations  10,000    10,000     10,000  
## R2            0.072      0.467      0.365  
## Adjusted R2   0.072      0.467      0.365  
## ===========================================
...
\NormalTok{    d[ , literacy }\SpecialCharTok{:=} \FunctionTok{rnorm}\NormalTok{(sim\_size, }\AttributeTok{mean =}\NormalTok{ d}\SpecialCharTok{$}\NormalTok{affluence, }\AttributeTok{sd =} \DecValTok{2}\NormalTok{)]}
\NormalTok{    d[ , tau      }\SpecialCharTok{:=} \FunctionTok{rnorm}\NormalTok{(sim\_size, }\AttributeTok{mean =} \DecValTok{5} \SpecialCharTok{+}\NormalTok{ californian)] }\DocumentationTok{\#\# + d$affluence)}
\NormalTok{    d[ , postY    }\SpecialCharTok{:=}\NormalTok{  preY }\SpecialCharTok{+}\NormalTok{ tau}\SpecialCharTok{*}\NormalTok{treat]}
\NormalTok{\}}
...
\NormalTok{mod0 }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}\textquotesingle{}}
...
\NormalTok{mod1 }\OtherTok{\textless{}{-}} \StringTok{\textquotesingle{}\textquotesingle{}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{https://www.youtube.com/watch?v=K_8vta9XDpc}}
...
\NormalTok{d[ , }\FunctionTok{mean}\NormalTok{(ability), by }\OtherTok{=}\NormalTok{ .(schooling\_10)]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{d[ , }\FunctionTok{mean}\NormalTok{(ability), by }\OtherTok{=}\NormalTok{ .(schooling\_hat)]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{d[ , }\FunctionTok{mean}\NormalTok{(ability), by }\OtherTok{=}\NormalTok{ .(lottery)]}
\end{Highlighting}
\end{Shaded}
...
\pandocbounded{\includegraphics[keepaspectratio]{241-live-session_files/figure-latex/unnamed-chunk-19-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{241-live-session_files/figure-latex/unnamed-chunk-20-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{241-live-session_files/figure-latex/unnamed-chunk-21-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{241-live-session_files/figure-latex/unnamed-chunk-22-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{241-live-session_files/figure-latex/unnamed-chunk-26-1.pdf}}
