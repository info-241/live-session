...
d[ , schooling := ability + family_income + lottery + rnorm(.N, mean=0, sd=1)]
...
-   What part of the RDD design is producing an unbiased causal estimate?
