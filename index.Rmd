...
author: "David Reiley, David Broockman, D. Alex Hughes, Micah Gell-Redman, Scott Guenther, & David Wheeler"
date: "`r Sys.Date()`"
...
6. **Create** A student can create a new or novel method from axioms or experience, and can evaluate the performance of this new method against existing appraoches or methods. 