...
2. If you had to draw out this causal claim, using arrow, what would it look like? 
...
4. If you acknowledge the association, does that compel you to believe the causal claim? 
...
6. (Optional) Name, and draw two *mechanisms* that might exist between suburbs and BMI. Why does the existence (or not) of these mechanisms *not* pose a fundimental problem to the causal claim that the authors make? 
