...
- Is there something that is common to each of these examples? Is this a general phenonemon, or is Athey very clever in picking examples? Said differently, is Athey making a clever argument or is a lot of what we do as data scientists actually causal work in disguise? 
...
4.  If you acknowledge the association, does that compel you to believe the causal claim? Why or why not? 
5. What are some of the confounding relationships that the authors identify? How do they adjust their analyses once they acknowledge the confounding problem? 
  1. 
  2. 
  3. 
  4. 
